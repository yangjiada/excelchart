...
class Chart(object):
    ...
    def set_size(self, width=480, height=288, x_scale=1, y_scale=1, x_offset=0, y_offset=0):
    ...
    def set_x_label(self, title, font_name):
        ...
        """
        if title:
            self.chart.set_x_axis({'name': title, 'name_font': {'name': font_name}})

    def set_y_label(self, title, font_name):
        ...
        """
        if title:
            self.chart.set_y_axis({'name': title, 'name_font': {'name': font_name}})

    def set_x_grid(self, grid):
        if grid:
            self.chart.set_x_axis({'major_gridlines': {'visible': grid}})

    def set_y_grid(self, grid):
        if grid:
            self.chart.set_y_axis({'major_gridlines': {'visible': grid}})
...
class ExcelChart(object):
    ...
    def bar(self, frame, sheet_name=None,  subtype=None, data_labels=False, title=None, x_label=None, y_label=None,
        ...
        chart.set_x_grid(grid=x_grid)
        chart.set_y_grid(grid=y_grid)
...
if __name__ == '__main__':
    ...
    ax = ec.bar(bar, sheet_name='bar')
    ax2 = ec.barh(bar, sheet_name='barh')
    ax3 = ec.line(bar, sheet_name='line')
