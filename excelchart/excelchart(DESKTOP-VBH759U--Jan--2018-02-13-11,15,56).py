...
class Chart(object):
    ...
    def set_title(self, title, font='Arial', size=16, bold=True, italic=False, underline=False,
        ...
        if title:
            self.chart.set_title({
                ...
                'overlay': overlay,
                'layout': {'x': 0.13, 'y': 0.26, 'width': 0.73, 'height': 0.57}
            })
        # else:
    ...
    def set_x_tick_mark(self, major_type=None, minor_type=None):
        ...
        :param major_type: inside, outside, cross, default none
        :param minor_type: inside, outside, cross, default none
        :return:
        """
        self.chart.set_x_axis({
...
if __name__ == '__main__':
    ...
    ax.set_title('标题ABC123', font='华文彩云')
